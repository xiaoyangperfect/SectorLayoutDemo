...
/*				try {
	   ...
	   public static class Menu1 implements RadialMenuWidget.RadialMenuEntry
	   {
	   ...
	   public static class Menu2 implements RadialMenuWidget.RadialMenuEntry
	   {
	      ...
	      private List<RadialMenuWidget.RadialMenuEntry> children = new ArrayList<RadialMenuWidget.RadialMenuEntry>(Arrays.<RadialMenuWidget.RadialMenuEntry>asList( new StringOnly(), new IconOnly(), new StringAndIcon() ));
	   ...
	   public static class Menu3 implements RadialMenuWidget.RadialMenuEntry
	   {
		  ...
		  public String getLabel() { return null; } 
	      public int getIcon() { return R.mipmap.ic_launcher; }
	      public List<RadialMenuWidget.RadialMenuEntry> getChildren() { return null; }
	      public void menuActiviated()
	      {
	   ...
	   public static class NewTestMenu implements RadialMenuWidget.RadialMenuEntry
	   {
	      ...
	      public int getIcon() { return 0; }
	      private List<RadialMenuWidget.RadialMenuEntry> children = new ArrayList<RadialMenuWidget.RadialMenuEntry>( Arrays.asList( new StringOnly(), new IconOnly() ) );
	      public List<RadialMenuWidget.RadialMenuEntry> getChildren() { return children; }
	      public void menuActiviated()
	      {
	   ...
	   public static class CircleOptions implements RadialMenuWidget.RadialMenuEntry
	   {
	      ...
	      public int getIcon() { return 0; }
	      private List<RadialMenuWidget.RadialMenuEntry> children = new ArrayList<RadialMenuWidget.RadialMenuEntry>(Arrays.<RadialMenuWidget.RadialMenuEntry>asList( new RedCircle(), new YellowCircle(), new GreenCircle(), new BlueCircle() ));
	      public List<RadialMenuWidget.RadialMenuEntry> getChildren() { return children; }
	      public void menuActiviated()
	      {
